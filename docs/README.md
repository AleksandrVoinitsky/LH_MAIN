# Документация проекта «Лакхантеры: Вирус V»

Это сжатая навигация по извлечённой проектной документации. Утверждения ниже отражают только исходные материалы; спорные и неполные положения вынесены в разделы «Открытые вопросы».
